...
/* Created on:     16/01/2025 10:16:34 p. m.                    */
/*==============================================================*/
...
alter table USUARIO
   drop constraint FK_USUARIO_USUARIO_Q_CONTACTO;
...
drop index USUARIO_QUE_TAMBIEN_ES_FK;
...
/*==============================================================*/
/* Index: USUARIO_QUE_TAMBIEN_ES_FK                             */
/*==============================================================*/
create index USUARIO_QUE_TAMBIEN_ES_FK on USUARIO (
   CONSECCONTACTO ASC
);
...
alter table USUARIO
   add constraint FK_USUARIO_USUARIO_Q_CONTACTO foreign key (CONSECCONTACTO)
      references CONTACTO (CONSECCONTACTO);
